  /*
    custom.jquery.utils.js - 2015-02-02
  ...
  */
  ...
  function stringFormat(format, params)
  {
    ...
    /// var sValue;
    /// //
    /// sValue = stringFormat("{0}.{1}", stringFormatParams = new Array(sID, sName));
    /// ...
    /// </code>
    /// </example>
  ...
  /// <remarks>
  /// 請確認對象物件支援 checked 屬性否則將無作用(皆傳回 false), 如 input checkbox, ASP.NET CheckBox 等.
